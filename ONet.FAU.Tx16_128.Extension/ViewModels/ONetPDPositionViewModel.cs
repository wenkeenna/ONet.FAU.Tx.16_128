...
{
    public class ONetPDPositionViewModel : IDialogAware
    {
        public ONetPDPosition ToolIns { get; set; }
        /// <summary>
        /// 取消命令
        /// </summary>
        ...
        public ONetPDPositionViewModel(IMotionSystemService motionSystemService, IEventAggregator eventAggregator, IDialogService dialogService)
        {
            _eventAggregator = eventAggregator;
            _dialogService = dialogService;
            _motionSystemService = motionSystemService;

            ToolIns = new ONetPDPosition();
        ...
        public void OnDialogOpened(IDialogParameters parameters)
        {
            ...
            {
                ToolIns = (ONetPDPosition)toolIns;
            }
        }
        #endregion
